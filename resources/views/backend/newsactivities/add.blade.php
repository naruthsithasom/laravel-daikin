        ...
        <div class="content">
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                <h2 class="text-lg font-medium mr-auto">
                    News & Activities / Add New
                </h2>
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <button class="btn btn-primary shadow-md mr-2 w-24"
                        onclick="location.href='{{ url('/dashboard/news_activities') }}'">Back</button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 lg:col-span-6">
                    ...
                    <div class="intro-y box p-5">
                        <div>
                            <label for="crud-form-1" class="form-label">Headline TH</label>
                            <input id="crud-form-1" type="text" class="form-control w-full" placeholder="">
                        </div>

                        <div class="mt-3">
                            <label for="crud-form-1" class="form-label">Content TH</label>
                            <div class="editor">
                                        ...
                                        <div class="border-2 border-dashed dark:border-darkmode-400 rounded-md pt-4">
                                            ...
                                            <div class="px-4 pb-4 flex items-center cursor-pointer relative">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    icon-name="image" data-lucide="image"
                                                    class="lucide lucide-image w-4 h-4 mr-2">
                                                    <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                                                    <circle cx="8.5" cy="8.5" r="1.5"></circle>
                                                    <polyline points="21 15 16 10 5 21"></polyline>
                                                </svg> <span class="text-primary mr-1">Upload a file</span> or drag and
                                                drop
                                                <input type="file"
                ...
                <div class="intro-y col-span-12 lg:col-span-6">
                    ...
                    <div class="intro-y box p-5">
                        <div>
                            <label for="crud-form-1" class="form-label">Headline EN</label>
                            <input id="crud-form-1" type="text" class="form-control w-full" placeholder="">
                        </div>
                        <div class="mt-3">
                            <label for="crud-form-1" class="form-label">Content EN</label>
                            <div class="editor">
                                <p>Content of the editor.</p>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class=" box intro-y col-span-12 lg:col-span-6 p-5">
                    <div class="mt-3">
                        <label for="crud-form-1" class="form-label">Twiiter</label>
                        <input id="crud-form-1" type="text" class="form-control w-full" placeholder="">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="form-check form-switch flex flex-col items-start mt-3">
                        <label for="post-form-5" class="form-check-label ml-0 mb-2">Highlights</label>
                        <input id="post-form-5" class="form-check-input" type="checkbox">
                    </div>
                    <div class="form-check form-switch flex flex-col items-start mt-3">
                        <label for="post-form-5" class="form-check-label ml-0 mb-2">Home page</label>
                        <input id="post-form-5" class="form-check-input" type="checkbox">
                    </div>
                    <div class="form-check form-switch flex flex-col items-start mt-3">
