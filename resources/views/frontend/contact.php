...
<section class="row">
    <div class="col-12 banner-inside wow fadeInDown">
        <figure>
            ...
            <img src="images/banner-contact.webp" alt="">
        </figure>
    </div>
</section>
                ...
                <div class="col-12 col-xl-5 wow fadeInLeft">
                    <div class="box-contactinfo">
                        ...
                        <div class="contact-social">
                            <a href="" target="_blank"><img src="images/icon-fb.svg" alt=""></a>
                            <a href="" target="_blank"><img src="images/icon_youtube.svg" alt=""></a>
                            <a href="" target="_blank"><img src="images/icon_twitter.svg" alt=""></a>
                            <a href="" target="_blank"><img src="images/icon-line.svg" alt=""></a>
                        </div>
                    </div>
                </div>
...
<section class="row">
    <div class="col-12 col-md-4 link-contact">
        <a href="">
            <figure>
                <span></span><img src="images/photo-contact_02.webp" alt="">
            </figure>
            <div class="caption-services">
				<div class="topic-services">coporate info</div>
				<div class="home-descservices">
					<div class="twolines">
					    To be a production base for air conditioner parts (Key device) of the Daikin group developed into the DX-factory
					</div>
    ...
    <div class="col-12 col-md-4 link-contact">
        <a href="">
            <figure>
                <span></span><img src="images/photo-contact_04.webp" alt="">
            </figure>
            <div class="caption-services">
				<div class="topic-services">Careers</div>
				<div class="home-descservices">
					<div class="twolines">
					We thrive when our teams are made up of people from different backgrounds, cultures, genders, education, training, interests, and skills.
					</div>
    ...
    <div class="col-12 col-md-4 link-contact">
        <a href="">
            <figure>
                <span></span><img src="images/photo-contact_06.webp" alt="">
            </figure>
            <div class="caption-services">
				<div class="topic-services">Daikin plant tour</div>
				<div class="home-descservices">
					<div class="twolines">
					Accelerating Our 3 Structures Of Collaborative Innovation, Let Us Win In This Era Of Change
					</div>
