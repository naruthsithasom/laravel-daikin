            ...
            <div class="row">
                ...
                <div class="col-7 col-md-4">
                    <div class="topbar-right">
                        <div class="toplang">
                            <a href="#"><img src="images/en_flag.svg" alt=""></a>
                            <a href="#" class="active"><img src="images/th_flag.svg" alt=""></a>
                        </div>
            ...
            <div class="box-scrollmenu">
                <ul class="menu-popup-main">
                    ...
                    <li class="menu-popup-hassub">
                        ...
                        <ul class="menu-popup-submenu">
                            <li><a href="production.php">Production Process</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <ul class="menubar">
                                ...
                                <li class="hassub"><a>Corporate Info</a>
                                    <ul class="submenu">
                                        <li><a href="vision-mission.php">Vision & Mission</a></li>
                                        <li><a href="history.php">History</a></li>
                                        <li><a href="certificate.php">Certification</a></li>
