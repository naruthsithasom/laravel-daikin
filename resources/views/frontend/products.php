...
<section class="row">
    <div class="col-12 banner-inside wow fadeInDown">
        <figure>
            ...
            <img src="images/banner-products.webp" alt="">
        </figure>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="products-content">
                        <p><img src="images/products_03.jpg" alt=""></p>
                        <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="products-content">
                        <p><img src="images/products_06.png" alt=""></p>
                        <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="products-content">
                        <p><img src="images/products_09.jpg" alt=""></p>
                        <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="products-content">
                        <p><img src="images/products_12.png" alt=""></p>
                        <p>
